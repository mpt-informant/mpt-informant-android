...
val numeratorColor = Color(0xFFC94C55)
val denominatorColor = Color(0xFF5B97B8)

@Composable
fun WeekLabel.color() = when (this) {
    WeekLabel.Numerator -> numeratorColor
    WeekLabel.Denominator -> denominatorColor
